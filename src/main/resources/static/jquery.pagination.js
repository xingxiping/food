        ...
        function drawLinks() {
            ...
            var appendItem = function (page_id, appendopts) {
                ...
                if (page_id == current_page) {
                    if (current_page == 0 && appendopts.classes == "prev") {
                        var lnk = jQuery("<li class=\"disabled\"><span class='current'>" + (appendopts.text) + "</span></li>");
                    } else if (current_page == np - 1 && appendopts.classes == "next") {
                        var lnk = jQuery("<li class=\"disabled\"><span class='current'>" + (appendopts.text) + "</span></li>");
                    } else {
                        var lnk = jQuery("<li class=\"active\"><span class='current'>" + (appendopts.text) + "</span></li>");
                    }
                } else {
                    var lnk = jQuery("<li><a" + " onclick='goToPage(" + page_id + ")'"  + ">" + (appendopts.text) + "</a></li>")
